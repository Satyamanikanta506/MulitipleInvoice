...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "billingdocument/test/integration/FirstJourney",
    "billingdocument/test/integration/BillingDocumentListJourney",
    "billingdocument/test/integration/BillingDocumentObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
