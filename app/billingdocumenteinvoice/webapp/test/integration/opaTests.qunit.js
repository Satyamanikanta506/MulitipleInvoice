...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "einvoice/billingdocumenteinvoice/test/integration/FirstJourney",
    "einvoice/billingdocumenteinvoice/test/integration/BillinginvListJourney",
    "einvoice/billingdocumenteinvoice/test/integration/BillinginvObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
